    ...
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2">AltSchool Exam(Counter App)</h2>
          <h3>Gatsby JS / Css</h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            AltSchool Exam(Setup a custom counter hook with increment, decrement, reset,
          ...
          <a
            href="https://github.com/Jizzyjay/AltSchool-Second-Exam"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://altexam.netlify.app/"
            target="_blank"
            rel="noreferrer"
          >
